...
//  }
  ...
  /**
   * 회원 삭제
   * http://localhost:9093/member/delete.do?memberno=9
   * @param memberno
   * @return
   */
...
//}
  ...
  try {
      ...
      searchVO.setTel(tel);
      MemberVO memberSearch = memberProc.memberIdSearch(searchVO);
  ...
  @RequestMapping(value = "/member/search_result_pwd", method = RequestMethod.POST)
  ...
  try {
      ...
      searchVO.setTel(tel);
      searchVO.setId(id);
      int memberSearch = memberProc.memberPwdCheck(searchVO);
      ...
      //searchVO.setPasswd(enpassword);
      
      memberProc.passwordUpdate(searchVO);
