...
public class MemberVO {
    ...
    public int getMemberPwdCheck() {
      return memberPwdCheck;
    }
    public void setMemberPwdCheck(int memberPwdCheck) {
      this.memberPwdCheck = memberPwdCheck;
    }
