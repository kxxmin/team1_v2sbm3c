...
<DIV class='content_body'>
          ...
          <td style='vertical-align: middle; text-align: center;'>
            <c:choose>
              <c:when test="${thumb1.endsWith('jpg') || thumb1.endsWith('png') || thumb1.endsWith('gif')}">
                ...
                <a href="/contents/read.do?contentsno=${contentsno}"><IMG src="/contents/storage/${thumb1 }" style="width: 115px; height: 120px;"></a> 
              </c:when>
  ...
  <form name='frm' id='frm' style='margin-top: 50px;' action="/order_pay/create.do" method='post'>
    ...
    <ASIDE class="aside_left">
      배송 정보<span style="font-size: 0.8em;">(* 태그는 필수 입력)</span>
    ...
    <tbody>
      <tr>
        ...
        <td style='width: 50%;'>
          ...
          <button type='button' id='btn_order_pay' class='btn btn-secondary' style='font-size: 1.5em;'>결제하기</button>
          <button type='button' id='btn_cart' class='btn btn-secondary' onclick="location.href='/cart/list_by_memberno.do'" 
