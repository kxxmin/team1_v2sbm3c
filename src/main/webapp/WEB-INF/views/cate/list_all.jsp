...
<DIV class='title_line'>카테고리 전체 목록</DIV>
  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="cateVO" items="${list }">
        ...
        <TD class="td_bs_left">
        <A href="/contents/list_by_cateno_search_paging.do?cateno=${cateno }">${name}</A></TD>
        ...
        <TD class="td_bs">
          ...
          <A href="./read_delete.do?cateno=${cateno}" title="삭제"><Img src = "/cate/images/delete.png" class="icon"></A> <br>
          ...
          <c:choose>
          	<c:when test="${visible == 'Y' }">
          		<A href="./update_visible_n.do?cateno=${cateno}" title="출력 모드 N으로 변경"><Img src = "/cate/images/close.png" class="icon"></A>
          	</c:when>
          	<c:when test="${visible == 'N' }">
          		<A href="./update_visible_y.do?cateno=${cateno}" title="출력 모드 Y로 변경"><Img src = "/cate/images/open.png" class="icon"></A>
          	</c:when>
          </c:choose>
        </TD>   
      </TR>  
