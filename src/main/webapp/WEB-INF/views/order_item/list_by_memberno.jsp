...
<c:import url="/menu/top.do" />
  ...
  <DIV class='bottom_menu'>
    <button type='button' onclick="location.href='/order_pay/list_by_memberno.do?memberno=${memberno}'" class="btn btn-secondary">결제 목록</button>
  </DIV>
</DIV>
