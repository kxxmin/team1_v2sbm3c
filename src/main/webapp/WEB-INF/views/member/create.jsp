...
<link href="/css/styles.css" rel="Stylesheet" type="text/css">  <!-- /static -->
...
<c:import url="/menu/top.do" />
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do'>
    <div class="form_input">
	      ...
	      아이디 입력 <input type='text' class="form-control" name='id' id='id' value='' required="required" style='width: 50%;' placeholder="아이디*" autofocus="autofocus">
	      <button type='button' id="btn_checkID" onclick="checkID()" class="btn btn-secondary">중복확인</button>
    </div>   
                <br>
                비밀번호 입력
    <div class="form_input">
      <input type='password' class="form-control" name='passwd' id='passwd' value='' required="required" style='width: 50%;' placeholder="패스워드*">
    </div>   

    <div class="form_input">
      <input type='password' class="form-control" name='passwd2' id='passwd2' value='' required="required" style='width: 50%;' placeholder="패스워드 확인*">
    </div>   
...
<!-- ------------------------------ DAUM 우편번호 API 종료 ------------------------------ -->
    ...
    <div class="form_input">
      <button type="button" id='btn btn-secondary' onclick="send()" class="btn btn-secondary">가입</button>
