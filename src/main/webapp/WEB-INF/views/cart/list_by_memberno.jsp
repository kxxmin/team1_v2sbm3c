    ...
    <tbody>
      <tr>
        ...
        <td style='width: 50%;'>
          ...
          <form name='frm' id='frm' style='margin-left: 40%;' action="/order_pay/create.do" method='get'>
            <button type='submit' id='btn_order' class='btn btn-secondary' style='font-size: 1.5em;'>주문하기</button>
          </form>
        <td>
      </tr>
    </tbody>
