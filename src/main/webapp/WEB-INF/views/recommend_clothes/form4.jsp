...
<body>
<DIV class="container">
    <H3 style='margin-top: 150px;'>관심 있는 의류를 골라주세요 (4/5)</H3>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/recommend_clothes/form5.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                 <TD class='td_image'>
                    <img id='img1' src="/recommend_clothes/images/4.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_clothes/images/14.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_clothes/images/54.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_clothes/images/34.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_clothes/images/44.png" style='float:left; height: 150px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
