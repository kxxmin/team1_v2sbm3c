...
<body>
<DIV class="container">
    <H3 style='margin-top: 150px;'>관심 있는 의류를 골라주세요 (2/5)</H3>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/recommend_clothes/form3.do' method='GET'>
        <input type='hidden' name='step1' value='${param.step1} '>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                 <TD class='td_image'>
                    <img id='img1' src="/recommend_clothes/images/2.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_clothes/images/12.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_clothes/images/52.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_clothes/images/32.png" style='float:left; height: 150px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_clothes/images/42.png" style='float:left; height: 150px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
